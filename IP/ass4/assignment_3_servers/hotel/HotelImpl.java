...
@SuppressWarnings("serial") public class HotelImpl extends java.rmi.server.UnicastRemoteObject implements Hotel
{
     ...
     */
    public synchronized int[] list() throws java.rmi.RemoteException
    {
     ...
     */
    public synchronized boolean book(int type, String guest) throws
     ...
     */
    public synchronized String[] guests() throws java.rmi.RemoteException
    {
        int i, j, ctr = 0;
